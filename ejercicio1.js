...
const gameDestructured = {title, gender, year} = game;
console.log(title);
console.log(gender);
console.log(year);
...
const fruitsDestructured = [fruit1, fruit2, fruit3] = fruits;
...
const {carName, itv , itv:[itv2015, itv2011, itv2020]} = car;
//LE CAMBIE EL NOMBRE AL COCHE PARA QUE NO ME DE ERRORES Y SE PUEDE VER TODO EL CÓDIGO SIN COMENTAR. 
console.log(carName);
console.log(itv);
console.log(itv2015);
console.log(itv2011);
