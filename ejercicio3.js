...
const mappedPeople = people.map(person => person.name.startsWith("A") ? "Anacleto" : person.name);
...
const visitedCities = cities.map(city => city.isVisited === true ? city.name+"(visitado)" : city.name);
